...
class WordleText {
  ...
  static const String instruction =
      'Use the on-screen keyboard to type a ${WordleConstant.numberOfBox}-letter word.\n\nOnce you\'ve entered all 5 letters, press the SUBMIT button to make your guess.';
